var size = 0;
var placement = 'point';
function categories_RekomendasiKawasanAgrowsiata_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Sangat Direkomendasikan':
...
var style_RekomendasiKawasanAgrowsiata_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    
    var labelText = ""; var value = feature.get("Kelas");
    ...
    var style = categories_RekomendasiKawasanAgrowsiata_1(feature, value, size, resolution, labelText,
